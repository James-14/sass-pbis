<template>
  <div class="app-container">
    <el-form :inline="true" :model="dataForm" class="demo-form-inline">
      <el-form-item label="机构用户" prop="title">
        <el-input v-model="dataForm.key" placeholder="输入机构、用户编码或名称查询" clearable></el-input>
      </el-form-item>
      <el-form-item>
    ...
    <el-table 
      ...
      <el-table-column align="center" fixed="right" label="操作" width="130">
        <template slot-scope="scope">
          <el-row>
            <el-button type="text" icon='el-icon-delete' @click='deleteHandle(scope.row.userOrgId)' size="small">删除</el-button>
          </el-row>
        </template>
      </el-table-column>
    </el-table>
