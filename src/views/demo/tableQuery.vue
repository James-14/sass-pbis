  ...
  <div class="app-container">
    <el-form :inline="true" ref="searchForm" :model="formInline" class="demo-form-inline">
      ...
      <el-form-item>
        ...
        <!-- <reset-button name='searchForm'></reset-button> -->
      ...
      <template v-if="seen">
        ...
        <el-form-item label="吃啥" prop="radio2">
        ...
        <singleSelect placeholder="請選擇" v-model="formInline.selectValue">
        </singleSelect>
         </el-form-item>
         <el-button type="text" @click="printSelectValue">查看单选select返回值</el-button>
          <el-form-item prop="multiValue">
        <multiSelect placeholder="請選擇" v-model="formInline.multiValue">
        </multiSelect>
          </el-form-item>
         <el-button type="text" @click="printMultiValue">查看多选select返回值</el-button>
      </template>
    </el-form>
    <el-table v-loading="listLoading" stripe :data="list" element-loading-text="Loading" border fit highlight-current-row>
    ...
    <return-button :path="this.repath"></return-button>
  </div>
</template>
...
import  singleSelect from '@/views/components/single-select'
import  multiSelect from '@/views/components/multi-select'
import  returnButton from '@/views/components/return-button'
import  resetButton from '@/views/components/reset-button'
